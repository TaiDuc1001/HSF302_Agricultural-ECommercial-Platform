    ...
    >
      ...
      {controls && (
        <>
          {/* Arrows */}
          <button
            className="left-4 absolute top-1/2 -translate-y-1/2 bg-black bg-opacity-40 text-white p-2 rounded-full hover:bg-opacity-70 focus:outline-none focus:ring-2 focus:ring-white z-20 hidden md:block"
            onClick={goToPrev}
          ...
          <button
            className="right-4 absolute top-1/2 -translate-y-1/2 bg-black bg-opacity-40 text-white p-2 rounded-full hover:bg-opacity-70 focus:outline-none focus:ring-2 focus:ring-white z-20 hidden md:block"
            onClick={goToNext}
